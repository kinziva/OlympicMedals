...
public class medals {
	...
	public void TheMostTestCase2() throws InterruptedException {
		...
		WebElement gold = driver
				.findElement(By.xpath("//th [@scope='col'] [@style = 'background-color:gold; width:6em;']"));
		WebElement silver = driver
				.findElement(By.xpath("//th [@scope='col'] [@style = 'background-color:silver; width:6em;']"));
		WebElement bronze = driver
				.findElement(By.xpath("//th [@scope='col'] [@style = 'background-color:#cc9966; width:6em;']"));
	...
	public String mostCountyMedal(WebElement medal, String medalName) {
		...
		String MedalCountry = driver.findElement(By.xpath(
				"//table[@class= 'wikitable sortable plainrowheaders jquery-tablesorter'] //tbody/tr[1]//th[@scope = 'row']"))
				.getText();
		String countXpath = "//table[@class = 'wikitable sortable plainrowheaders jquery-tablesorter']//tbody/tr[1]/";
		String MedalCount = "";
		switch (medalName) {
		case "gold":
			MedalCount = driver.findElement(By.xpath(countXpath + "td[2]")).getText();
			break;
		case "silver":
			MedalCount = driver.findElement(By.xpath(countXpath + "td[3]")).getText();
			break;
		case "bronze":
			MedalCount = driver.findElement(By.xpath(countXpath + "td[4]")).getText();
			break;
		case "total":
			MedalCount = driver.findElement(By.xpath(countXpath + "td[5]")).getText();
			break;
		}
	...
	public List<String> silver18() {
		...
		List<WebElement> silverElement = driver.findElements(
	...
	public static List<String> getSum2() {
		List<WebElement> bronze = driver.findElements(
				By.xpath("//table[@class = 'wikitable sortable plainrowheaders jquery-tablesorter']//tbody//td[4]"));
		List<WebElement> countries = driver.findElements(
				By.xpath("//table[@class='wikitable sortable plainrowheaders jquery-tablesorter']/tbody/tr/th/a"));
		// Map<String,Integer> bronzeTotal18 = new HashMap<>();
		// for (int i = 0; i < countries.size(); i++) {
		// bronzeTotal18.put((countries.get(i).getText()),
		// Integer.parseInt(bronze.get(i).getText()));
		// System.out.println("country: " + countries.get(i).getText()+ " bronze medal
		// count: " +bronze.get(i).getText());
		// }
